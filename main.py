...
• <b>Форматы файлов:</b> MP3, MP4, M4A, WAV, WEBM, OGG (голосовые сообщения).
• <b>Длительность аудио:</b> оптимальная длительность аудио — 7-8 минут, но сервис работает и с записями большей длительности. Пробуйте.

Если вам нужны особенные услуги (распознавание из видео, по ссылке, пакетное распознавание или у вас большие объёмы), просто свяжитесь с нами и мы повысим для вас лимиты или даже создадим отдельный продукт — стабильный, быстрый и безопасный.

Оплата услуг юридическими лицами на ИП (УСН) также доступна.
...
• /review_trials - Посмотреть заявки на пробный доступ
• /credit &lt;ID_пользователя&gt; &lt;минуты&gt; - Начислить минуты пользователю
• /remove_user - Показать список пользователей для удаления
• /stat - Показать статистику использования
---"""
